...
powerbuttonscript=/usr/bin/$daemonname.py	#/usr/bin/argononed.py

shutdownscript="/lib/systemd/system-shutdown/"$daemonname"-poweroff.py"	#/lib/systemd/system-shutdown/argononed-poweroff.py

daemonconfigfile=/etc/$daemonname.conf	#/etc/argononed.conf

configscript=/usr/bin/argonone-config
removescript=/usr/bin/argonone-uninstall

daemonfanservice=/lib/systemd/system/$daemonname.service		#/lib/systemd/system/argononed.service
